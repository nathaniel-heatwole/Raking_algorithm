...
orig_logit_eqn = 'Original logit:\n' + 'logit(pass) = ' + str(intercept) + ' + ' + str(slope) + '*(Hours)'
...
# labels
orig_label = 'Original logit (pass: ' + str(format(orig_total, fmt)) + ')'
shifted_label = 'Shifted curve (pass: ' + str(format(shifted_total, fmt)) + ')'
...
plt.title('Raking Algorithm - Shifting Logistic Regression Predictions', fontsize=title_size, fontweight='bold')
...
plt.text(max_hours_ceil, 0, orig_logit_eqn, va='bottom', ha='right', fontsize=legend_size, zorder=30)

# add vectors (arrows) showing the shift
